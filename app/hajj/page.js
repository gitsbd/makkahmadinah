    ...
    <>
      <section className="page-header">
        <div className="container">
          <h1>হজ্জ সম্পাদনের সম্পূর্ণ গাইড</h1>
          <p>দিনে দিনে বিস্তারিত নির্দেশিকা</p>
          <p className="section-count">মোট <strong>১০</strong>টি বিভাগ</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          >
            <div className="dua-item">
              ...
              <div className="important-note" style={{ backgroundColor: '#fff3e0', padding: '1.5rem', borderRadius: '8px', margin: '2rem 0', borderRight: '4px solid #ff9800' }}>
                <h4 style={{ color: '#e65100', marginTop: '0' }}>⚠️ গুরুত্বপূর্ণ মনে রাখবেন:</h4>
          ...
          <div className="completion-box">
            <h2>✅ হজ্জ সম্পন্ন!</h2>
            <p>আপনার হজ্জ সম্পন্ন হয়েছে। আল্লাহ আপনার হজ্জ কবুল করুন এবং আপনার সকল গুনাহ মাফ করুন।</p>
            <div className="important-note" style={{ marginTop: '1.5rem' }}>
              <strong>📝 মনে রাখবেন:</strong> হজ্জ সম্পন্ন করার পর নতুন জীবন শুরু করুন। আল্লাহর কাছে প্রতিশ্রুতি করুন যে আপনি আর গুনাহ করবেন না। <strong>মদিনা শরীফে গিয়ে মসজিদে নববীতে নামাজ পড়ুন এবং রাসূলুল্লাহ (সা.) এর রওজা শরীফে সালাম দিন।</strong>
            </div>
          </div>
        </div>
      </section>
