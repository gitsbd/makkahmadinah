    ...
    <>
      <section className="page-header">
        <div className="container">
          <h1>উমরাহ সম্পাদনের সম্পূর্ণ গাইড</h1>
          <p>ধাপে ধাপে নির্দেশিকা</p>
          <p className="section-count">মোট <strong>১৫</strong>টি বিভাগ</p>
        </div>
      </section>
      ...
      <section className="process-section">
        <div className="container">
          <div className="umrah-flowchart">
            <h2 style={{ textAlign: 'center', color: 'var(--primary-color)', marginBottom: '2rem', fontSize: '2rem' }}>
          ...
          <ExpandableSection 
           ...
           number={1}>
            <div className="dua-item">
              ...
              <ol style={{ marginRight: '2rem', lineHeight: '2' }}>
          ...
          <ExpandableSection 
           ...
           number={3}>
            <div className="dua-item">
              ...
              <div className="dua-box" style={{ marginTop: '1.5rem' }}>
          ...
          <ExpandableSection 
           ...
           number={5}>
            <div className="dua-item">
              ...
              <p className="info-text" style={{ marginTop: '1rem' }}><strong>বিমানযোগে আসা ব্যক্তিরা:</strong> বিমানে মিকাত অতিক্রম করার সময় ইহরাম গ্রহণ করবেন।</p>
            </div>
          </ExpandableSection>
           ...
           number={6}>
            <div className="dua-item">
              ...
              <div className="dua-box" style={{ marginTop: '1.5rem' }}>
                ...
                <p className="info-text" style={{ marginTop: '1rem' }}>এই হাদীস থেকে বোঝা যায় যে উমরাহ বারবার করা যায় এবং প্রতিবারই এর ফজিলত রয়েছে।</p>
              </div>
            </div>
          </ExpandableSection>
          ...
          <ExpandableSection 
           ...
           number={7}>
            <div className="dua-item">
              ...
              <div className="important-note" style={{ backgroundColor: '#e3f2fd', padding: '1.5rem', borderRadius: '8px', margin: '2rem 0', borderRight: '4px solid #2196f3' }}>
                <h4 style={{ color: '#1565c0', marginTop: '0' }}>📌 নারীদের জন্য বিশেষ নির্দেশনা:</h4>
          ...
          <ExpandableSection 
           ...
           number={15}>
            <div className="dua-item">
              ...
              <div className="info-text" style={{ margin: '1.5rem 0' }}>
              ...
              <div className="important-note" style={{ backgroundColor: '#e8f5e9', padding: '1.5rem', borderRadius: '8px', margin: '2rem 0', borderRight: '4px solid #4caf50' }}>
                <h4 style={{ color: '#2e7d32', marginTop: '0' }}>📌 গুরুত্বপূর্ণ মনে রাখবেন:</h4>
                <ul style={{ marginRight: '1.5rem', lineHeight: '2' }}>
          ...
          <div className="completion-box">
            <h2>✅ উমরাহ সম্পন্ন!</h2>
            <p>আপনার উমরাহ সম্পন্ন হয়েছে। আল্লাহ আপনার উমরাহ কবুল করুন।</p>
            <div className="important-note" style={{ marginTop: '1.5rem' }}>
              <strong>📝 মনে রাখবেন:</strong> উমরাহ সম্পন্ন করার পর <strong>মদিনা শরীফে গিয়ে মসজিদে নববীতে নামাজ পড়ুন এবং রাসূলুল্লাহ (সা.) এর রওজা শরীফে সালাম দিন।</strong>
            </div>
          </div>
        </div>
      </section>
