      ...
      <SectionWrapper className="duas-section">
          ...
          <DuaCategory id="surahs" title="সূরা" defaultOpen={false} number={8}>
            ...
            <div className="surah-item">
              ...
              <p className="translation"><strong>অনুবাদ:</strong> বলুন, হে কাফিরগণ! (১) আমি তোমাদের ইবাদত করি না যা তোমরা ইবাদত কর। (২) এবং তোমরাও ইবাদতকারী নও যা আমি ইবাদত করি। (৩) এবং আমি ইবাদতকারী নই যা তোমরা ইবাদত করেছি। (৪) এবং তোমরাও ইবাদতকারী নও যা আমি ইবাদত করি। (৫) তোমাদের জন্য তোমাদের ধর্ম এবং আমার জন্য আমার ধর্ম। (৬)</p>
            </div>
          </DuaCategory>
      </SectionWrapper>
    </>
