    ...
    <>
      <section className="page-header">
        <div className="container">
          <h1>উমরাহ ও হজ্জ দোয়া</h1>
          <p>উমরাহ ও হজ্জের জন্য প্রয়োজনীয় সমস্ত গুরুত্বপূর্ণ দোয়া ও সূরা</p>
          <p className="section-count">মোট <strong>৮</strong>টি দোয়া বিভাগ</p>
        </div>
      </section>
        ...
        <div className="container">
          <DuaCategory id="ihram" title="ইহরামের দোয়া" defaultOpen={false} number={1}>
            <div className="dua-item">
              ...
              <p className="translation"><strong>অনুবাদ:</strong> হে আল্লাহ, আমি উমরাহর জন্য উপস্থিত</p>
            </div>
            <div className="dua-item">
              <h3>তালবিয়া</h3>
              ...
              <p className="translation"><strong>অনুবাদ:</strong> হে আল্লাহ, আমি উপস্থিত, আমি উপস্থিত। আপনার কোন শরীক নেই, আমি উপস্থিত। নিশ্চয়ই সকল প্রশংসা, নেয়ামত ও রাজত্ব আপনার, আপনার কোন শরীক নেই।</p>
            </div>
          </DuaCategory>
          ...
          <DuaCategory id="mosque-entry" title="মসজিদে প্রবেশের দোয়া" defaultOpen={false} number={2}>
            ...
            <div className="dua-item">
              <h3>মসজিদ থেকে বের হওয়ার দোয়া</h3>
              <p className="arabic">اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكَ</p>
              <p className="transliteration">Allahumma Inni As'aluka Min Fadlik</p>
          ...
          <DuaCategory id="tawaf-duas" title="তাওয়াফের দোয়া" defaultOpen={false} number={3}>
            <div className="dua-item">
              ...
              <p className="translation"><strong>অনুবাদ:</strong> আল্লাহর নামে শুরু করছি এবং আল্লাহ সর্বশ্রেষ্ঠ</p>
            </div>
            <div className="dua-item">
              <h3>তাওয়াফের সময়</h3>
              ...
              <p className="translation"><strong>অনুবাদ:</strong> আল্লাহ পবিত্র, সকল প্রশংসা আল্লাহর, আল্লাহ ছাড়া কোন ইলাহ নেই, আল্লাহ সর্বশ্রেষ্ঠ</p>
            </div>
            <div className="dua-item">
              <h3>রুকনে ইয়ামানির কাছে</h3>
          ...
          <DuaCategory id="zamzam" title="জমজম পান করার দোয়া" defaultOpen={false} number={4}>
            <div className="dua-item">
              ...
              <p className="translation"><strong>অনুবাদ:</strong> হে আল্লাহ, আমি আপনার কাছে উপকারী জ্ঞান, প্রশস্ত রিজিক এবং সকল রোগ থেকে আরোগ্য চাই</p>
            </div>
          </DuaCategory>
          ...
          <DuaCategory id="sai-duas" title="সাঈ (সাফা-মারওয়া) এর দোয়া" defaultOpen={false} number={5}>
            <div className="dua-item">
              <h3>সাফায় দোয়া</h3>
              <p className="arabic">إِنَّ الصَّفَا وَالْمَرْوَةَ مِنْ شَعَائِرِ اللَّهِ فَمَنْ حَجَّ الْبَيْتَ أَوِ اعْتَمَرَ فَلَا جُنَاحَ عَلَيْهِ أَنْ يَطَّوَّفَ بِهِمَا</p>
              <p className="transliteration">Innas Safa Wal Marwata Min Sha'airillah</p>
              <p className="translation"><strong>অনুবাদ:</strong> নিশ্চয়ই সাফা ও মারওয়া আল্লাহর নিদর্শনসমূহের অন্তর্গত</p>
            </div>
            <div className="dua-item">
              <h3>সাঈর সময়</h3>
              <p className="info-text"><strong>প্রধান দোয়া:</strong></p>
